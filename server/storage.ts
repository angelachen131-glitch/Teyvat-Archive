  ...
  private seedData() {
    const characters: Character[] = [
      ...
      },
      {
        ...
        region: "Mondstadt",
        role: "Support",
        description: "The Anemo Archon in disguise, a wandering bard with great power.",
        lore: "An elemental being disguised as a humble bard who wanders the lands. In reality, Venti is the Anemo Archon who leads the winds of Teyvat.",
        talents: "Prioritize Elemental Burst > Elemental Skill > Normal Attack. Burst is your main grouping and damage tool.",
        recommendedArtifacts: ["Viridescent Venerer", "Noblesse Oblige"],
        recommendedWeapons: ["Elegy for the End", "Stringless", "Favonius Warbow"],
        buildPriority: "Stack Elemental Mastery (800-1200) for massive burst scaling. Energy Recharge (160-180%) for uptime.",
        constellations: "C1 boosts ATK speed. C2 grants extra skill charges. C6 reduces damage taken during burst.",
        imageUrl: "https://enka.network/ui/UI_AvatarIcon_Venti.png"
      },
      {
        id: "xingqiu",
        name: "Xingqiu",
        ...
        region: "Liyue",
        role: "Support",
        description: "A young man with remarkable swordsmanship, protecting Liyue's aquatic interests.",
        lore: "A humble bookkeeper who is an excellent swordsman. Xingqiu is one of the most versatile supports in Genshin, enabling countless team compositions.",
        talents: "Prioritize Elemental Burst > Elemental Skill > Normal Attack. Burst is your main support tool.",
        recommendedArtifacts: ["Emblem of Severed Fate", "Noblesse Oblige"],
        recommendedWeapons: ["Sacrificial Sword", "Xingqiu's Special Sword", "Favonius Sword"],
        buildPriority: "Focus on ER (200%+) for burst spam, then ATK%. Hydro DMG and Crit Rate for personal damage.",
        constellations: "C2 increases Hydro application. C4 heals. C6 grants elemental damage bonus.",
        imageUrl: "https://enka.network/ui/UI_AvatarIcon_Xingqiu.png"
      },
      {
        id: "kokomi",
        ...
        region: "Inazuma",
        role: "Healer",
        description: "The devoted heir to Sangonomiya, leading underwater kingdom with grace.",
        lore: "The current Sangonomiya Clan heir and high priestess of Watatsumi Island. Despite her youth, she is an accomplished strategist.",
        talents: "Prioritize Elemental Burst > Elemental Skill > Normal Attack. Healing scales with HP.",
        recommendedArtifacts: ["Ocean-Hued Clam", "Tenacity of the Millelith"],
        recommendedWeapons: ["Thrilling Tales of Dragon Slayers", "Prototype Amber", "Healing Bonus Catalyst"],
        buildPriority: "Stack HP% for healing and shield strength. Energy Recharge (150%+) for burst uptime.",
        constellations: "C1 extends burst duration. C2 heals enemies. C6 provides DMG bonus after healing.",
        imageUrl: "https://enka.network/ui/UI_AvatarIcon_Kokomi.png"
      },
      {
        id: "mona",
        name: "Mona",
        ...
        region: "Mondstadt",
        role: "Support",
        description: "A mysterious astrologer with unparalleled talent for divination.",
        lore: "A powerful astrologer who analyzes fate through the stars. Mona is eccentric but brilliant, serving as the translator of Teyvat.",
        talents: "Prioritize Elemental Burst > Elemental Skill > Normal Attack. Burst provides crowd control and buffs.",
        recommendedArtifacts: ["Noblesse Oblige", "Tenacity of the Millelith"],
        recommendedWeapons: ["Thrilling Tales", "Favonius Codex", "Sacrificial Fragments"],
        buildPriority: "Focus on ER (200%+), then ATK% and Hydro DMG. Crit Rate/DMG for personal damage.",
        constellations: "C1 extends burst duration. C2 enables crit damage on debut. C6 grants Hydro damage bonus.",
        imageUrl: "https://enka.network/ui/UI_AvatarIcon_Mona.png"
      },
      {
        id: "alhaitham",
        name: "Alhaitham",
        ...
        region: "Sumeru",
        role: "DPS",
        description: "A renowned scholar and scribe of the Akademiya with exceptional intellect.",
        lore: "A brilliant scholar and the author of multiple scholarly works. Alhaitham is methodical, analytical, and one of the strongest Dendro DPS characters.",
        talents: "Prioritize Normal Attack > Elemental Burst > Elemental Skill. Normal attacks are your primary damage.",
        recommendedArtifacts: ["Gilded Dreams", "Deepwood Memories"],
        recommendedWeapons: ["Light of Foliar Incision", "Dendrite Bow", "Iron Sting"],
        buildPriority: "Focus on EM (800-1000), ATK%, Dendro DMG, and Crit Rate/DMG. High EM is crucial.",
        constellations: "C1 boosts damage. C2 reduces NA cooldown. C6 increases DMG after burst.",
        imageUrl: "https://enka.network/ui/UI_AvatarIcon_Alhaitham.png"
      },
      {
        id: "yelan",
        name: "Yelan",
        ...
        region: "Liyue",
        role: "Sub-DPS",
        description: "An enigmatic woman operating in the shadows of Liyue Harbor.",
        lore: "A mysterious intelligence broker who works in the shadows. Yelan is a powerful off-field support DPS with excellent Hydro application.",
        talents: "Prioritize Elemental Burst > Elemental Skill > Normal Attack. Burst is your main damage.",
        recommendedArtifacts: ["Emblem of Severed Fate", "Tenacity of the Millelith"],
        recommendedWeapons: ["Aqua Simulacra", "Thundering Pulse", "Favonius Warbow"],
        buildPriority: "Focus on ER (200%+), then ATK% and Crit Rate/DMG. HP% for personal survivability.",
        constellations: "C1 extends burst. C2 extends duration. C6 grants damage bonus after burst.",
        imageUrl: "https://enka.network/ui/UI_AvatarIcon_Yelan.png"
      },
      {
        id: "xiao",
        name: "Xiao",
        ...
        region: "Liyue",
        role: "DPS",
        description: "The vigilant Yaksha, guardian of Liyue with a troubled past.",
        lore: "A Yaksha bound by contract to protect Liyue. Despite his rough exterior, Xiao cares deeply for humanity.",
        talents: "Prioritize Normal Attack > Elemental Burst > Elemental Skill. Burst forms your primary damage.",
        recommendedArtifacts: ["Viridescent Venerer", "Gladiator's Finale"],
        recommendedWeapons: ["Primordial Jade Winged-Spear", "Blackcliff Pole", "The Catch"],
        buildPriority: "Focus on ATK%, Anemo DMG Bonus, and Crit Rate/DMG. Energy Recharge (130-160%) needed.",
        constellations: "C1 extends burst. C2 grants extra charges. C6 increases Normal Attack DMG.",
        imageUrl: "https://enka.network/ui/UI_AvatarIcon_Xiao.png"
      },
      {
        id: "jean",
        name: "Jean",
        ...
        region: "Mondstadt",
        role: "Support",
        description: "The acting Grand Master of the Knights of Favonius.",
        lore: "The diligent and hardworking Acting Grand Master of the Knights. Jean is a skilled swordmaster and support healer.",
        talents: "Prioritize Elemental Burst > Elemental Skill > Normal Attack. Burst heals and deals damage.",
        recommendedArtifacts: ["Viridescent Venerer", "Noblesse Oblige"],
        recommendedWeapons: ["Aquila Favonia", "Favonius Sword", "Amenoma Kageuchi"],
        buildPriority: "Focus on ATK% and Anemo DMG, then Energy Recharge (160%+). Healing Bonus for healing scaling.",
        constellations: "C1 boosts ATK. C2 reduces cooldown. C6 grants Anemo damage bonus.",
        imageUrl: "https://enka.network/ui/UI_AvatarIcon_Jean.png"
      },
      {
        id: "barbara",
        name: "Barbara",
        ...
        region: "Mondstadt",
        role: "Healer",
        description: "The Deaconess of the Church of Favonius, beloved by all.",
        lore: "A cheerful deaconess of the Church of Favonius who heals people with her voice. Barbara is a free 4-star healer available early in the game.",
        talents: "Prioritize Elemental Burst > Elemental Skill > Normal Attack. Healing scales with ATK.",
        recommendedArtifacts: ["Maiden Beloved", "Tenacity of the Millelith"],
        recommendedWeapons: ["Thrilling Tales of Dragon Slayers", "Prototype Amber", "Wine and Song"],
        buildPriority: "Focus on ATK%, Energy Recharge (160%+), and Healing Bonus. HP% for survivability.",
        constellations: "C1 extends ring duration. C2 reduces cooldown. C6 revives on burst.",
        imageUrl: "https://enka.network/ui/UI_AvatarIcon_Barbara.png"
      },
      {
        id: "beidou",
        name: "Beidou",
        ...
        region: "Liyue",
        role: "Sub-DPS",
        description: "Captain of the Crux, a fearless fleet captain commanding respect on the seas.",
        lore: "The legendary captain of the Crux, Beidou commands a powerful fleet. She is known for her fearlessness and skill in combat.",
        talents: "Prioritize Elemental Burst > Elemental Skill > Normal Attack. Burst is your main damage.",
        recommendedArtifacts: ["Emblem of Severed Fate", "Noblesse Oblige"],
        recommendedWeapons: ["Wolf's Gravestone", "Prototype Archaic", "Serpent Spine"],
        buildPriority: "Focus on ER (200%+) for burst uptime, then ATK% and Crit Rate/DMG. Electro DMG bonus.",
        constellations: "C1 adds counter hit. C2 extends burst. C6 grants lightning chain.",
        imageUrl: "https://enka.network/ui/UI_AvatarIcon_Beidou.png"
      },
      {
        id: "keqing",
        name: "Keqing",
        ...
        region: "Liyue",
        role: "DPS",
        description: "The Yuheng of Liyue Qixing, swift and determined in her pursuit of justice.",
        lore: "One of the Liyue Qixing who serves as the chief secretary. Keqing is serious, efficient, and one of the fastest characters.",
        talents: "Prioritize Normal Attack > Elemental Skill > Elemental Burst. Skill is used for mobility and damage.",
        recommendedArtifacts: ["Thunder Soother", "Gilded Dreams"],
        recommendedWeapons: ["Mistsplitter Reforged", "Primordial Jade Cutter", "The Black Sword"],
        buildPriority: "Focus on ATK%, Electro DMG Bonus, and Crit Rate/DMG. Energy Recharge for burst uptime.",
        constellations: "C1 enhances skill damage. C2 extends burst. C6 grants elemental damage boost.",
        imageUrl: "https://enka.network/ui/UI_AvatarIcon_Keqing.png"
      },
    ];
